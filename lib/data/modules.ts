...
export const MODULES: ModuleData[] = [
    ...
    lessons: [
      ...
      },
      {
        ...
        questions: [
          ...
          {
            id: 'pr4',
            question: 'A client has a glass/ceramic cooktop with baked-on residue. Which product do you use?',
            options: ['Lysol All Purpose Cleaner', 'Weiman Stainless Steel Cleaner', 'Weiman Cooktop Cream', 'Bar Keepers Friend Soft Cleanser'],
            correct: 2,
            explanation: 'Weiman Cooktop Cream is specifically formulated for glass and ceramic cooktops. Using the wrong product — especially abrasives — can permanently scratch or damage the surface.',
          },
          {
            id: 'pr5',
            question: 'You finish cleaning the bathroom. Is it okay to use the same cloth to wipe down the kitchen counters next?',
            options: ['Yes, if the cloth looks clean', 'Yes, if you rinse it first', 'No — always use separate cloths for bathrooms and kitchens', 'Only if you spray it with Lysol first'],
            correct: 2,
            explanation: 'Never cross-contaminate. Bathroom cloths stay in the bathroom. Kitchen cloths stay in the kitchen. Mixing them is one of the most common — and most serious — mistakes a cleaner can make.',
          },
          {
            id: 'pr6',
            question: 'What is the correct order to clean a room?',
            options: ['Mop the floors first, then dust surfaces', 'Top-to-bottom, dry tasks before wet tasks', 'Wet tasks first to loosen dirt, then dry', 'It doesn\'t matter as long as everything gets done'],
            correct: 1,
            explanation: 'Always work top-to-bottom so dust and debris fall to the floor before you mop. Dry tasks (dusting, wiping) always come before wet tasks (mopping). Reversing this is a very common mistake that means re-doing work.',
          },
          {
            id: 'pr7',
            question: 'A client\'s stainless steel appliances have fingerprints and smudges. Which product do you use?',
            options: ['Dawn Platinum Soap and water', 'Lysol All Purpose Cleaner', 'Bar Keepers Friend', 'Weiman Stainless Steel Cleaner'],
            correct: 3,
            explanation: 'Weiman Stainless Steel Cleaner is the correct product for stainless steel appliances. Using the wrong cleaner can leave streaks, residue, or even scratch the finish.',
          },
        ],
      },
    ],
...

  {
    ...
    lessons: [
      ...
      {
        slug: 'residential-checklist',
        title: 'Customizable Cleaning Checklist',
        type: 'checklist',
      },
      {
        slug: 'move-in-out',
    ...
    lessons: [
      {
        ...
        questions: [
          {
            id: 'f1',
            question: 'A client asks you to do an extra task that isn\'t part of today\'s scope of work. What should you say?',
            options: [
              'Agree and do it for free to keep them happy',
              'Quote them a price for the extra work yourself',
              'Let them know it\'s not included today, and you\'ll pass the request to management',
              'Tell them you\'re too busy and refuse',
            ],
            correct: 2,
            explanation: 'You are never authorized to quote prices or agree to out-of-scope work. Let the client know and pass the request to management.',
          },
          {
            id: 'f2',
            question: 'What does the WHMIS corrosive symbol indicate about a product?',
            options: [
              'It can catch fire easily',
              'It causes skin and eye burns on contact',
              'It is a pressurized container',
              'It is harmful to aquatic life',
            ],
            correct: 1,
            explanation: 'The corrosive symbol means the product can cause skin and eye burns — gloves and eye protection are required.',
          },
          {
            id: 'f3',
            question: 'How must a secondary spray bottle (one you\'ve mixed or transferred product into) be labelled?',
            options: [
              'No label is needed if you remember what\'s inside',
              'Just a colored cap to tell bottles apart',
              'Product name, hazard information, and "See SDS" or a QR code',
              'Only the date it was filled',
            ],
            correct: 2,
            explanation: 'Secondary bottles must show the product name, hazard info or symbols, and a way to access the SDS — never leave a bottle unlabelled.',
          },
          {
            id: 'f4',
            question: 'Which surfaces is Lysol Toilet Bowl Cleaner approved for?',
            options: [
              'Sinks, counters, and toilet exteriors',
              'Toilet bowls and urinals only',
              'Any hard, non-porous surface',
              'Floors and baseboards',
            ],
            correct: 1,
            explanation: 'Lysol Toilet Bowl Cleaner is corrosive and approved for toilet bowl/urinal interiors only — never sinks, counters, or floors.',
          },
          {
            id: 'f5',
            question: 'EasyOff Oven Cleaner must always be used:',
            options: [
              'On aluminum surfaces for best results',
              'Without gloves, since it rinses off easily',
              'In a well-ventilated area, with gloves and eye protection',
              'On any kitchen surface that needs degreasing',
            ],
            correct: 2,
            explanation: 'EasyOff is highly corrosive and flammable. It requires good ventilation, gloves, and eye protection, and should never be used on aluminum.',
          },
          {
            id: 'f6',
            question: 'A client tells you they\'re unhappy with the quality of a recent clean. What\'s the right response?',
            options: [
              'Defend your work and explain why it\'s fine',
              'Listen fully, apologize sincerely, and let management know right away',
              'Tell them it\'s probably a one-time issue and not worth mentioning to management',
              'Offer to redo the entire clean for free on the spot',
            ],
            correct: 1,
            explanation: 'Always listen, apologize sincerely, and notify management immediately — never argue or minimize a client\'s complaint.',
          },
          {
            id: 'f7',
            question: 'You arrive at a job and none of the entry methods listed in Jobber work. What do you do?',
            options: [
              'Leave immediately without telling anyone',
              'Wait outside indefinitely until someone shows up',
              'Try every entry method listed, then text management immediately if you\'re still locked out',
              'Call the client directly before checking Jobber',
            ],
            correct: 2,
            explanation: 'Always check and try every entry method in Jobber first. If you\'re still unable to access the property, text management right away — never leave without notifying them.',
          },
          {
            id: 'f8',
            question: 'When washing microfiber cloths, what should you never add?',
            options: ['Laundry detergent', 'Cold water', 'Fabric softener', 'A normal wash cycle'],
            correct: 2,
            explanation: 'Fabric softener coats and clogs microfiber, reducing its cleaning effectiveness. Use laundry detergent only.',
          },
          {
            id: 'f9',
            question: 'The vacuum WPG provides you with is meant to be used:',
            options: [
              'As your primary vacuum on every job',
              'Only as a backup — clients almost always supply their own',
              'Only for commercial jobs',
              'It is not provided to cleaners',
            ],
            correct: 1,
            explanation: 'Clients almost always supply a vacuum for use in their home. The one WPG provides is a backup only.',
          },
          {
            id: 'f10',
            question: 'How is the employee vehicle allowance paid out?',
            options: [
              'As a single annual lump sum',
              'Biweekly, with the amount based on part-time vs. full-time status',
              'Only to independent contractors',
              'It is not offered to employees',
            ],
            correct: 1,
            explanation: 'Employees receive a vehicle allowance paid out biweekly alongside regular pay, with the amount set based on part-time or full-time status.',
          },
        ],
      },
    ],
