    ...
    lessons: [
      {
        ...
        sections: [
          {
            heading: 'How Employees Are Paid',
            bullets: [
              'Starting rate: $19/hour',
              'Paid biweekly on a regular schedule',
              'Overtime at 1.5× after 40 hours/week',
              'Vacation pay: 4% of wages, paid out each pay period',
              '8 general holidays in Manitoba',
            ],
          },
          {
            ...
            bullets: [
              ...
              'CPP deduction: your portion (5.95%) — the company matches it',
              'EI deduction: your portion (1.66%) — the company pays 2.32%',
              'Income tax deduction: federal and provincial tax withheld automatically',
              'Net pay: what you actually receive',
            ],
          },
          {
            heading: 'What the Company Handles For You',
            bullets: [
              'All tax deductions remitted to the CRA on your behalf',
              'WCB coverage provided — workplace injuries are covered',
              'T4 slip issued at year-end for your tax return',
      ...
      },
      {
        ...
        sections: [
          {
            heading: 'How Contractors Are Paid',
            bullets: [
              'Starting rate: $23/hour',
              'More frequent payouts than employees',
              'Submit invoices or log jobs directly in the company system',
              'No deductions made — you receive your full gross payment every time',
              'T4A slip issued at year-end (not a T4)',
            ],
          },
          {
            ...
            bullets: [
              ...
              'The more legitimate expenses you track, the less taxable income you have — completely legal and encouraged by the CRA',
              'Set aside approximately 25–30% of income for taxes',
              'File taxes as self-employed using T1 + T2125 (Business Income)',
            ],
          },
          {
            heading: 'Eligible Business Expenses',
            bullets: [
              'Vehicle: business-use mileage at $0.72/km (first 5,000 km) — track from day one',
              'Gas explained: driving to 4 clients/day, 5 days/week adds up to thousands in deductions each year',
              'Cleaning supplies and equipment you purchase',
              'Business-use portion of your phone bill',
              'Liability insurance premiums (~$50/month via Zensurance — fully deductible)',
              'Professional development and training costs',
            ],
          },
          {
            ...
            bullets: [
              ...
              'Both employee AND employer portions of CPP (11.9% total)',
              'WCB: carry your own coverage, or WPG covers it if you don\'t',
              'Liability insurance is required before starting work',
            ],
          },
        ],
        ...
        tip: 'Mileage is one of the biggest deductions most contractors overlook. At the 2025 CRA rate of $0.72/km, driving just 30 km/day 5 days a week adds up to over $5,600 in deductions in a year.',
      },
    ],
  },
