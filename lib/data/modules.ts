        ...
        sections: [
          {
            ...
            bullets: [
              'Regular payroll schedule — pay is issued on a consistent schedule',
              'Hourly or per-job rate as agreed in your employment agreement',
              'Vacation pay is included as required by Manitoba Employment Standards',
              'CPP (Canada Pension Plan) contributions are deducted from your pay and matched by the company',
              'EI (Employment Insurance) premiums are deducted from your pay',
            ],
          },
          {
            ...
            bullets: [
              ...
              'CPP deduction: your portion of pension contributions',
              'EI deduction: employment insurance premiums',
              'Income tax deduction: federal and provincial tax',
